...
import { formatNearBalance } from '../../utils/formatBalance'
...
const NearTokenChip: React.FC<NearTokenChipProps> = memo(
  ({ amount, prefix, contractId, withBalance, variant = 'outlined', onClick }) => {
